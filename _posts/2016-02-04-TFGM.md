 ...
 * ROS knowledge would be helpful (ROS indigo version).
 * Linux knowledge would be helpful (all the robots code runs on Ubuntu 14.04).
 * English skill would be helpful (the majority of research articles are in this language).
...
**Supervisors**: *Raúl Pérula-Martínez*
